/*
 ...
 File Name  : H3BR6.c
 Description: Main source code for H3BR6 module, controlling a 6-digit 7-segment display and indicator LEDs.
 ...
 * In case of status{H3BR6_OUT_OF_RANGE OR H3BR6_ERR_WRONGPARAMS }
 */
