...
#define COMMON_LED_PIN 			        GPIO_PIN_14
#define COMMON_LED_GPIO_PORT 	        GPIOB
...
typedef enum {
	...
	a_LETTER =0X77, b_LETTER =0X7C, c_LETTER =0X58, d_LETTER =0X5E, e_LETTER =0X79, f_LETTER =0X71,
	g_LETTER =0X6F, h_LETTER =0X74, i_LETTER =0x04, j_LETTER =0X1E, k_LETTER =0X75, l_LETTER =0X38,
	m_LETTER =0X15, n_LETTER =0X54, o_LETTER =0X5c, p_LETTER =0X73, q_LETTER =0X67, r_LETTER =0X50,
	s_LETTER =0X6d, t_LETTER =0X78, u_LETTER =0X1C, v_LETTER =0X3e, w_LETTER =0X7E, x_LETTER =0X64,
	y_LETTER =0X6E, z_LETTER =0X5b,

	/* Capital Letter Representation*/
	A_LETTER =0X77, B_LETTER =0X7C, C_LETTER =0X39, D_LETTER =0X5E, E_LETTER =0X79, F_LETTER =0X71,
	G_LETTER =0x3d, H_LETTER =0x76, I_LETTER =0x06, J_LETTER =0X1E, K_LETTER =0X75, L_LETTER =0X38,
	M_LETTER =0X15, N_LETTER =0X37, O_LETTER =0X3f, P_LETTER =0X73, Q_LETTER =0X67, R_LETTER =0X50,
	S_LETTER =0X6d, T_LETTER =0X78, U_LETTER =0X1c, V_LETTER =0X3e, W_LETTER =0X7E, X_LETTER =0X64,
	Y_LETTER =0X6E, Z_LETTER =0X5b,
